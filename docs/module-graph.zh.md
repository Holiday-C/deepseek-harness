...
flowchart TD
  ...
  pkg_app_restart --> pkg_agent
  pkg_app_restart --> pkg_cmdline
  pkg_app_restart --> pkg_invariants
  pkg_app_restart --> pkg_jobs
  pkg_app_restart --> pkg_llm
  pkg_app_restart --> pkg_tools
...
| [`app-restart`](../packages/boot/app-restart) | `boot` | [`agent`](../packages/core/agent), [`cmdline`](../packages/boot/cmdline), [`invariants`](../packages/runtime-diagnostics/invariants), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`tools`](../packages/core/tools) |
