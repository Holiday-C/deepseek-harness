...
| [`app-restart`](../packages/boot/app-restart) | `boot` | [`agent`](../packages/core/agent), [`cmdline`](../packages/boot/cmdline), [`jobs`](../packages/jobs/jobs), [`llm`](../packages/llm/llm), [`tools`](../packages/core/tools) |
